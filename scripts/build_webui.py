...
# Validate inline JavaScript in data/index.html before bundling
try:
    ...
    for idx, part in enumerate(parts[1:], 1):
        ...
        if res.returncode != 0:
            ...
            print(res.stderr)
            sys.exit(1)
    print("✅ All JavaScript script blocks in data/index.html passed syntax validation.")
...
out.append(f"// Compressed Size: {len(data)} bytes (uncompressed: {len(raw_data)} bytes)")
